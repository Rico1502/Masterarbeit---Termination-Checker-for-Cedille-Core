...
module ElaborationCheckerListN where
...
prsAndElabLN :: MonadLogic m => String -> Int -> m (Elaboration VariableE)
prsAndElabLN cTrm dim = elaborateLN ((erasTrm . fromString) cTrm) dim

    -- Algorithm 2 -> Main algorithm!
elaborateLN :: MonadLogic m => TrmP -> Int -> m (Elaboration VariableE)
elaborateLN term dim = 
    firstElab term dim >>-
    secondElab2 dim >>-
    --fourthElab >>-
    fifthElab >>-
